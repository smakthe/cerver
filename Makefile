...
INCLUDES = -I$(SRC_DIR) -I$(SERVER_DIR) -I$(MODELS_DIR) -I$(CONTROLLERS_DIR) -I$(ROUTES_DIR) -I$(UTILS_DIR) -I$(DATABASE_DIR) -I$(DB_APP_DIR) -I$(DB_LOGICAL_DIR) -I$(DB_PHYSICAL_DIR)
